...
In python, there are some caveats before run the script. For example, if you want to run inside jupyter notebook enviroment, we should do the following:
	...
	1. Write the function in separate file, and the import as any python library. In this case, I write module called __workers__ and the function is called __create_dat__.
